...
if (!in_array($signupSource, ['free_signup', 'email_referral', 'fb_1cent', 'fb_100leads', 'fb_startnow'], true)) { $signupSource = 'free_signup'; }
...
elseif (strpos($srcPath, '/startnow') === 0) { $signupSource = 'fb_startnow'; }  // must precede the /start prefix check
